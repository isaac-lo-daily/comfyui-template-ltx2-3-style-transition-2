# template_ltx2_3_style_transition (2)
ComfyUI workflow Dockerized via [comfyui-wizard](https://comfy.getrunpod.io).
Submission: https://comfy.getrunpod.io/dashboard/submissions/kd7eqqd5y3m3t33atczyd7xwvs88bsrx
## Build it yourself
```bash
...
5. Submit the API workflow JSON (api-workflow.json in this repository) to the endpoint. The workflow must be wrapped inside the input.workflow field of the request body.
